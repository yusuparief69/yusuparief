...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="alert alert-secondary" style="color: #383d41; background-color: #e2e3e5; border-color: #d6d8db;">
            Selamat <?= $salam; ?>, Selamat datang <b><?= $_SESSION['fullname']; ?></b> di Aplikasi <?= $row1['nama_app']; ?>.
        </div>
        <!-- -->
        <?php
        include "../../config/koneksi.php";
        ...
        <img src="../../assets/dist/img/logo_sekolah.png" width="120px" height="120px" style="display: block; margin-left: auto; margin-right: auto; margin-top: 100px;">
