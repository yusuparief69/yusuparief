            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title" style="font-family: 'Quicksand', sans-serif; font-weight: bold;">Data Pemabayaran</h3>
                            ...
                            ?>
                                <tbody>
                                    <tr>
			                    		...
			                    		<a href="editpembayaran?id=<?php echo $row['id_pembayaran']; ?>"class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a> 
					                    <a href="hapuspembayaran?id=<?php echo $row['id_pembayaran']; ?>"  class="btn btn-danger btn-sm btn-del"><i class="fa fa-trash"></i></a>
				                    </td>
                                    </tr>
                                </tbody>
                            <?php
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    swal({
                        icon: 'error',
                        title: 'Dibatalkan',
                        text: 'Data pembayaran tersebut aman !'
                    })
                }
            });
    })
