            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="inputpetugas" class="btn btn-info"><i class="fa fa-send"></i> Input Data</a> 
                        </div>
                    </div>
                    <!-- /.box-header -->
                            ...
                            ?>
                                <tbody>
                                    <tr>
			                    		...
			                    		<a href="editpetugas?id=<?php echo $row['id_petugas']; ?>"class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a> 
					                    <a href="hapuspetugas?id=<?php echo $row['id_petugas']; ?>" class="btn btn-danger btn-sm btn-del"><i class="fa fa-trash"></i></a>
				                    </td>
                                    </tr>
                                </tbody>
                            <?php
