            ...
            <div class="col-xs-12">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tgl-peminjaman" data-toggle="tab">Pembayaran SPP</a></li>
                        <li><a href="#tgl-pengembalian" data-toggle="tab">Data Petugas</a></li>
                        <li><a href="#nama-anggota" data-toggle="tab">Data Anggota ( Siswa )</a></li>
                    </ul>
                            ...
                            <section id="new">
                                <form action="pages/function/Laporan.php?aksi=tgl_pinjam" method="POST" target="_blank">
                                    <div class="form-group">
                                        <label>Data Pembayaran SPP</label>
