...
if ($_GET['aksi'] == "tgl_pinjam") {
    ...
    echo "<img src='../../../../assets/dist/img/logo_app.png' style='display: block; margin-left: auto; width: 90px; margin-bottom: -70px; margin-top: -38px; margin-right: 5px;'>";
    ...
    echo "</tr>";
    $no = 1;
    $sql = mysqli_query($koneksi, "SELECT * FROM pembayaran WHERE id_pembayaran = '$nama_anggota'");
    while ($row = mysqli_fetch_assoc($sql)) {
        echo "<tbody>";
        echo "<tr>";
        echo "<td>" . $no++ . "</td>";
