        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <img src="../../assets/dist/img/logo_sekolah.png" style="width: 125px; height: 125px; display: block; margin-left: auto; margin-right: auto; margin-top: -10px; margin-bottom: 15px;">
                        <!-- Animasi -->
